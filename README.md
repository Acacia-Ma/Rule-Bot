...
# 支持逗号分隔多个群组 ID
- ALLOWED_GROUP_IDS=-1002413971610,-1001234567890
```

> 💡 **群组 ID 格式说明**
>
> Telegram Supergroup 的 ID 需要在前面添加 `-100` 前缀：
>
> - 如果你获取到的群组 ID 是 `2413971610`
> - 那么需要配置为 `-1002413971610`
>
> **获取群组 ID 的方法：**
>
> 1. 将 [@userinfobot](https://t.me/userinfobot) 添加到群组
> 2. 它会自动显示群组的完整 ID（已包含 -100 前缀）
